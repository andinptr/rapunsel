                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a class="btn btn-warning" type="button" href="edit_jenjang.php?id_jenjang=<?= $data['id_jenjang']; ?>"><i class="bi bi-pencil-square" aria-hidden="true"></i></a></td>
                                                <td><a class="btn btn-danger" type="button" onclick="return confirm('Data akan di Hapus?')" href="hapus_jenjang.php?id_jenjang=<?= $data['id_jenjang']; ?>"><i class="bi bi-trash-fill" aria-hidden="true"></i></a></td>
                                            </tr>
                                        <?php
                                        }
                                        ?>
